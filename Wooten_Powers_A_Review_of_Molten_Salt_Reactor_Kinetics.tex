...
approaches.  
\textcolor{red}{In Table \ref{tbl:prk} a selected group of PRK based computational
tools which exhibit desirable characteristics are presented.}
...
through \ref{tbl:codes5} \textcolor{red}{,and specifically highlighted in
Table \ref{tbl:qs},
...
compared to and accepted for use. \textcolor{red}{In Table \ref{select_codes} a selected group
of computational tools exhibiting desirable characteristics and implementing
a range of approaches is presented.}
