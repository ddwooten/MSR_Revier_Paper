...
\author{Daniel Wooten}\footnote{Corresponding author: danieldavidwooten@gmail.com}
...
\begin{figure}[h]
   ...
   \centering
   \includegraphics[width=0.8\textwidth]{Zhang_Development_2009-1_Fig_20}
   \caption{Figure 15.a from \cite{zhang_development_2009-1}.} 
\end{figure}
