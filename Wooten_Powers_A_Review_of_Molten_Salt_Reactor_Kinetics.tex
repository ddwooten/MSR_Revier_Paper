...
The ''Precursor Treatment" row indcates what methods were used to
...
the modeling of the DNP distrubiton.
...
The ''TH X Eq" rows indicate wheather or not an equation governing ''X" was
...
thermohydraulics model; this is not realted to the ''Precursor Diffusion." row.
...
Discritization" rows indicate what type of, if any, discriziation scheme was
...
\begin{table}[H]
    \caption{A continued listing of all computational tools for CFR kinetics modelling
        ...
        \ref{tbl:codes5} for details on additional computational tools.}
    \label{tbl:codes4}
    \begin{center}
        \begin{tabular}{|c c c c c|}
            \hline
...
\begin{table}[H]
    \caption{A continued listing of all computational tools for CFR kinetics modelling
        ...
        \ref{sec:models} for an explanation of this table as well as tables
        \ref{tbl:codes1}, \ref{tbl:codes2}, \ref{tbl:codes3}, and
        \ref{tbl:codes4} for details on additional computational tools.}.
    \label{tbl:codes5}
    \begin{center}
        \begin{tabular}{|c c c c c|}
            \hline
            Reference &
                ...
                Validation & No & MSRE & TWIGL\tablefootnote{See
                    ...
                    and explanation}, 3D LMW\textsuperscript{99}, MSRE\\
            \hline
        \end{tabular}
    \end{center}
\end{table}
