...
\begin{table}[H]
    \caption{A selected listing of MGD based computational tools for CFR
                ...
                balance of the computational tools data. Additional MGD based
                computational tools can be found in appendix \ref{app:tools} in
                Table \ref{tbl:mgd2}.}
    \label{tbl:mgd}
    \begin{center}
        \begin{tabular}{|c c c c c|}
            \hline
                ...
                Code Name & None & None \tabelfootnote{Code detailed is the
                                                           PoliMi version} &
                            DT-MSR & DYN3D-MSR\\
                ...
                N. Dimension & 3D & 2D, r-z & 3D, r-z & 3D\\
