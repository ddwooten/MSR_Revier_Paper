...
In contrast to solid fuel reactors where delayed neutron precursors (DNP) decay
 ...
 diffusive. Considering that the transit time through the entire core and flow loop system of many proposed CFRs is comparable to the decay constants of,
at least, the longer DNP groups 
