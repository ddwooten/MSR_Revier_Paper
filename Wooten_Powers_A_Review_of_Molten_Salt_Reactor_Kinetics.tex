...
\begin{abstract}
Interest in circulating fuel reactors, particuarly molten salt reactors (MSR)
 of the
fluid fuel type, has been growing in the last two decades starting with a
resurgance of interest in Europe. Since this time there have been a growing
...
representative codes from each of the main modelling catagories. Finally a
...
\textcolor{red}{JEFF, COULD YOU INCLUDE SOMETHING ABOUT THE AQUEOUS REACTOR IN HERE? Also, I'm not particuarly gifted with intros, so please do have at this}
...
(MSRE) which sucessfully built and operated an 8 MW molten salt reactor (MSR) for 
more than 1000 hours with both \ce{^{233}U} and \ce{^{235}U} fuel at differnt
...
the many differnces between solid fuel reactors, which have recieved the
...
neutron precurssors (DNPs) from their originating positions. In a solid fuel
...
where they may decay in any number of places with varraying amounts of
...
include coupling, loose and tight, to thermalhydraulics simulations. In the
...
and they were found to produce results with varraying degrees of resemblance to
...
as a compromise between the accuracy of the MGD models and the speek of the PRK
...
rotationally symetric models for open core type systems and more robust 3D
approaches. Furthermore the differences between various flow regimes assumed
in channel type reactors were found to have non-neglible impacts on kinetics
analysis and transient modeling indicating that at least loose coupling with
a thermalhydraulics code may greatly improve the performance of kinetics models
