...
\begin{figure}[h]
   ...
   \caption{Figure 19 from \cite{cheng_development_2014}.} 
...
\ref{tbl:dulla_flow_regimes}. The flow regimes refered to in figure
\ref{fig:dulla_flow_regimes} and table \ref{tbl:dulla_flow_regimes} are best
summarized by figures \ref{fig:dulla_flow_map} and \ref{dulla_flow_adf}.
...
\begin{table}[h]
    ...
    \begin{center}
        \begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}
            ...
            & $\lambda(s^{-1}$ & 1 & 2 & 3 & 4 & 5 & 6 & \multirow{2}{*}{Total} \\
            \cline{4 - 9}
