...
from Politecnico di Milano (Polimi), as presented in \cite{fiorina_modelling_2004}, is
chosen. It should be noted that in the implementation of the ULOF transient for
the MSFR in \cite{fiorina_modelling_2004} no other flows, other than the primary
...
\begin{figure}[h]
   ...
   \caption{Figure 9 from \cite{fiorina_modelling_2004}.} 
