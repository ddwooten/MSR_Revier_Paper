...
resurgence of interest in Europe. Since then there have been a growing
...
\par The history of MSRs began with the Aircraft Reactor Experiment at Oak Ridge National
 ...
 (MSRE) which was successfully operated, with a full power rating of 8 MW, for more than 13,000
 equivalent full-power hours with both \ce{^{233}U} and \ce{^{235}U} fuel at different
points in time. No other MSR has been built since the closing of the MSRE project
 ...
 Reactor (MSBR) and Denatured Molten Salt Reactor (DMSR) as well as other MSR studies
...
include coupling neutronics calculations, loosely or tightly, with thermohydraulics simulations. In the
following sections, a review and discussion of the
unique physical phenomenon tied to CFR kinetics modeling will be presented. 
Afterwards, an extended discussion of the various proposed models for CFR
kinetics analysis will be provided along with sample transient simulations for
...
\begin{table}[h]
    ...
    \begin{center}
        \begin{tabular}{|c c|}
            \hline
            AHR & Aqueous Homoegenous Reactor \\
...
\begin{figure}[h]
   ...
   \caption{Figure 2.5a from \cite{zanetti_development_2016} showing the experimental and
   simulated results of a 24 pcm reactivity insertion in the MSRE during 1 MWth operation.} 
...
\begin{figure}[h]
   ...
   \caption{Figure 2.6a from \cite{zanetti_development_2016} showing the experimental and
...
Discretization" rows indicate what type of, if any, discritization scheme was
